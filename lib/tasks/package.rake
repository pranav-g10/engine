namespace :package do
  ...
  task create: :environment do
    Locomotive::Package.create!([
                        ...
                        { name: "Agency", price: 19, desc: "", expire_after: 365, expire_type: "yearly", limitation: {num_of_projects: 999, num_of_pages: 999, num_of_images: 5000}, site_count: 10 },
                        { name: "Professional", price: 8, desc: "", expire_after: 365, expire_type: "yearly", limitation: {num_of_projects: 100, num_of_pages: 100, num_of_images: 1000},site_count: 5 },
                        { name: "Basic", price: 7, desc: "", expire_after: 365, expire_type: "yearly", limitation: {num_of_projects: 10, num_of_pages: 10, num_of_images: 100},site_count: 3 },
